...
export const services: Service[] = [
  {
    ...
    problem:
      "Готовите системи не отговарят на начина, по който работи вашият бизнес.",
    solution:
      "Изграждаме собствена система около вашите процеси, роли и данни.",
    components: [
      "Интерфейс",
      "Бизнес логика",
      "База данни",
  ...
  },
  {
    ...
    problem:
      "Работата е разпръсната между отделни инструменти, файлове и ръчни стъпки.",
    solution:
      "Свързваме модули, роли и работни потоци в една среда, която може да се развива.",
    components: [
      "Модули",
      "Права и роли",
      "Работни потоци",
  ...
  },
  {
    ...
    problem:
      "Повтарящата се ръчна работа губи време и създава грешки, които после се търсят на ръка.",
    solution:
      "Свързваме процеса със системата: задействане, изпълнение и запис на резултата.",
    components: [
      "Процес",
      "Правила",
      "Задействане",
  ...
  },
  {
    ...
    problem:
      "Има данни и повтаряща се обработка, но липсва ясна следваща стъпка в системата.",
    solution:
      "Прилагаме AI към конкретна задача — анализ, обработка, класификация или автоматизация — и го свързваме с реалния процес.",
    components: [
      "Данни",
      "Задача",
      "Модел или услуга",
  ...
  },
  {
    ...
    problem:
      "Нужен е работещ уеб вход към бизнеса, а не страница, която свършва след публикуването.",
    solution:
      "Изграждаме уеб приложение или сайт като част от система — с структура, данни и възможност за следващи модули.",
    components: [
      "Интерфейс",
      "Съдържание",
      "Приложение",
  ...
  },
  {
    ...
    problem:
      "Някои нужди се повтарят между организации и заслужават собствен продукт, а не еднократен проект.",
    solution:
      "Развиваме собствени системи с дългосрочна архитектура. HR HUB 360 е първият публичен продукт в тази линия.",
    components: [
