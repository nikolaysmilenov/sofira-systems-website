...
const baseClassName =
  "inline-flex min-h-11 items-center justify-center gap-2 rounded-md px-5 text-sm font-semibold tracking-normal transition-colors duration-200 disabled:cursor-not-allowed disabled:opacity-60";
